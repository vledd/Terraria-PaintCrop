...
# TODO it would be also nice to make same function but not by number but by (x, y) of image. Like: (1, 0) -> (54, 0)
def get_image_coords_by_no(tileset: Image,
                           image_no: int,
...
# get_image_coords_by_no(tiles, 1, (3, 3), TilesetTilesOrder.LEFT2RIGHT)
